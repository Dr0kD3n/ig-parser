      ...
      <div className="app-container">
        <header className="header">
          ...
          <div className="actions-row">
            ...
            >
              <span className="user-email" style={{ fontSize: '13px', color: 'var(--text-muted)' }}>
                {user.email}
              </span>
              <button
        ...
        <nav className="nav-card">
          ...
          <div className="actions-row">
            {activeTab === 'controls' && (
              <div
                className="header-bot-configs"
                style={{ display: 'flex', gap: '16px', color: 'var(--text-dim)', fontSize: '13px' }}
              >
                <label
            ...
            <button
              className={`btn ${restoreStatus.running ? 'btn-danger' : 'btn-primary'}`}
