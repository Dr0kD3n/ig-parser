...
console.log(
  'database_pre_restore_20260313.sqlite:',
  getCount('config/database_pre_restore_20260313.sqlite')
);
console.log(
  'database_backup_20260309_220151.sqlite:',
  getCount('config/database_backup_20260309_220151.sqlite')
);
