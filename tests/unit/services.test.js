...
require.cache[configPath] = {
    ...
    exports: {
        ...
        getSetting: vi.fn(async (key) => {
            ...
            try { return row ? JSON.parse(row.value) : null; } catch { return row?.value; }
        })
    }
};
...
describe('Service Test Suite', () => {
    ...
    describe('StateManager', () => {
        ...
        it('saveResult should insert profile if new', async () => {
            ...
            expect(mockDb.run).toHaveBeenCalledWith(expect.stringContaining('INSERT INTO profiles'), expect.anything());
        });
    });
