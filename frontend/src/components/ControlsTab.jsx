...
export default function ControlsTab({ botStatus, onBotControl, onClearLogs, logs, tr, isLoading }) {
    ...
    return (<div className="controls-panel tab-content-fade">
            ...
            <div className="control-card">
                ...
                {!scraperCollapsed && (<div style={{ marginTop: 12 }}>
                ...
                ? (<div style={{ display: 'flex', gap: '12px' }}>
                                    ...
                                    <button className="btn-primary" style={{ background: 'hsl(var(--warning))', boxShadow: 'none' }} onClick={async (e) => {
            ...
            <div className="control-card">
                ...
                {!parserCollapsed && (<div style={{ marginTop: 12 }}>
            ...
            <div className={`stream-card${streamCollapsed ? ' collapsed' : ''}`}>
                ...
                {!streamCollapsed && (<div className="stream-container" onClick={() => setIsZoomed(true)}>
                        <img src={`/api/live-view?t=${liveViewTimestamp}`} style={{ display: (botStatus.index || botStatus.parser) ? 'block' : 'none' }} alt="Live View" onError={(e) => { e.target.style.display = 'none'; if (e.target.nextSibling)
            e.target.nextSibling.style.display = 'block'; }} onLoad={(e) => { e.target.style.display = 'block'; if (e.target.nextSibling)
