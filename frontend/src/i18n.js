export const TRANSLATIONS = {
    ru: {
        ...
        checker_title: 'Авто-проверка диалогов',
        checker_desc: 'Заходит в отправленные диалоги и проверяет наличие ответа от пользователя.',
        btn_start_checker: 'Запустить',
        btn_stop_checker: 'Остановить',
        stats_template: 'Шаблон',
        stats_sent: 'Отправлено',
        stats_replied: 'Ответов',
        stats_replied_rate: 'Конверсия в ответ',
        stats_continued: 'Продолжено',
        stats_continued_rate: 'Конверсия в продолжение',
